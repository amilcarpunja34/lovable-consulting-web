    ...
    <footer className="bg-slate-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <address className="text-slate-300 not-italic mb-6">
              ...
              <a href="mailto:contato@consultapro.com.br" className="hover:text-primary-blue transition-colors">contato@consultapro.com.br</a>
            </address>
            <Button 
        ...
        <div className="text-center text-slate-400">
          <p>© {new Date().getFullYear()} ConsultaPro. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
